...
import com.subhu.movieBookingSystem.dao.TheatreDao;
import com.subhu.movieBookingSystem.dao.UserDao;
...
import com.subhu.movieBookingSystem.services.CityService;
...
public class InitServiceImpl implements InitService {
	 ...
	 *
	 * int i ; -- defining a variable i=5 ; -- assigning a value
	 *
	 *
	...
	private void createMovies() {
		...
		movie2.setMovieName("Movie1_Name1");
		movie2.setTrailerUrl("Movie1_T_URL");
		movie2.setStatus(statuses.get(1));
		movie2.setMovieDescription("Movie1 description");
		movie2.setDuration(120);
		movie2.setTrailerUrl("Movie1_T_URL");
		movie2.setReleaseDate(LocalDateTime.of(2018, 4, 27, 5, 30));
		movie2.setCoverPhotoUrl("Movie1_C_URL");
